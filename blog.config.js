...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Narwal', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '你不認識我 剛好 我也不認識你', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://legend.disneyland.pro', // 网站地址
